...
-- Stores templates for various assessments (e.g., stress test).
...
-- Stores the results of completed assessments for each user.
...
-- Stores the history of coaching sessions with the AI.
...
-- Tracks changes in goal progress over time for analytics.
...
-- Seed data for assessment templates
