-- Добавляем недостающие колонки в таблицу profiles
ALTER TABLE public.profiles 
ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ DEFAULT NOW(),
ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ DEFAULT NOW();

-- Создаем триггер для updated_at в profiles
...
-- Создаем функцию для создания профиля (используем full_name, который уже есть в таблице)
